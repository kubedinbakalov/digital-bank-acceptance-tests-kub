...
import co.wedevx.digitalbank.automation.ui.steps.data_transformers.DataTimeFormat;
...
public class NewCheckingAccountSteps {
    ...
    public void the_user_should_see_the_following_transactions(List<Transactions> expectedTransactions) {
        ...
        assertEquals(dataTimeFormat.getFormattedDateTime(), actualResultMap.get("actualDate"));
